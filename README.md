...
| `/admin/auth-log` | **Activity log** — logins/logouts/failures + key in-session actions (admin only) |
...
- [x] **Admin activity log** — login / logout / failed attempts + key actions (register/screen/issue/approve, etc.) at `/admin/auth-log`
